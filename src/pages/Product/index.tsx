    ...
    <>
      ...
      <Section title="Mais detalhes" background="gray">
        <p>
          ...
          Interactive <br />
          <strong>EntertainmentIdiomas:</strong> O jogo oferece suporte a
          diversos idiomas, incluindo inglês, espanhol, francês, alemão,
          italiano, português, entre outros. As opções de áudio e legendas podem
          ser ajustadas nas configurações do jogo.
        </p>
      </Section>
      <Gallery defaultCover={residenteEvil} name="Jogo teste" />
    </>
  );
};
